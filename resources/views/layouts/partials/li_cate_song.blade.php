<li class="dropdown dropdown-large">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-music"></i> BÀI HÁT</a>
            ...
            if ($cate->cate_parent == 0) {
                ...
                foreach ($cates as $sub_cate) {
                    if ($cate->id == $sub_cate->cate_parent) {
                        echo "<li><a href='" . url("chu-de/$sub_cate->cate_title_slug/bai-hat") . "'>$sub_cate->cate_title</a></li>";
                    }
                }
                echo '</ul>';
                echo '</li>';
